...
opts.Add(PathVariable("target_path", "The path where the lib is installed.", "SimpleRPG/bin/"))
opts.Add(PathVariable("target_name", "The library name.", "libsimplerpg", PathVariable.PathAccept))
